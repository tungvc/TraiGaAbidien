			...
			$http(
				{
					...
					method: 'POST',
					url: 'http://localhost:8082/web/rename/rename_fanpage?username=' + $scope.user + '&password=' + $scope.pass + '&pageID=' + $scope.pageID + '&oldName=' + $scope.oldName + '&newName=' + $scope.newName,
					headers: {
